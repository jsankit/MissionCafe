...
//    }
	function onDeviceReady() {
    var firstrun = window.localStorage.getItem("EM1.0"); 
    if ( firstrun == null ) {
        window.localStorage.setItem("EM1.0", "1"); 
        var db = window.openDatabase("ExpenseManagerDB", "1.0", "Expense Manager", 200000);
