...
function populateDB(tx) {
	...
	var sql = 
		...
		"picture VARCHAR(200))";
    tx.executeSql(sql);
 tx.executeSql("INSERT INTO employee (id,firstName,lastName,managerId,title,department,officePhone,cellPhone,email,city,picture) VALUES (13,'Ankit','Dwivedi','','','','617-000-0012','781-000-0012','ankit@technowitty.com','Kolkata, WB','steven_wells.jpg')");
